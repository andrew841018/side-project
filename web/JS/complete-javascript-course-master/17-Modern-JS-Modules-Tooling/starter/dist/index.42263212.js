...
*/ //importing module
var _shoppingChartJs = require("./shoppingChart.js");
var _shoppingChartJsDefault = parcelHelpers.interopDefault(_shoppingChartJs);
console.log("import");
console.log((0, _shoppingChartJs.tq));
console.log((0, _shoppingChartJs.total));
(0, _shoppingChartJs.addToCart)("airplane".charAt(0).toUpperCase() + "airplane".slice(1), 100000);
console.log(_shoppingChartJs.total, _shoppingChartJs.tq);
(0, _shoppingChartJsDefault.default)("holy shit", " god damn");
...
(0, _shoppingChartJs.addToCart)("car", 1000);
(0, _shoppingChartJs.addToCart)("pig", 30);
console.log((0, _shoppingChartJs.cart));
...
console.log(ShoppingCart2.totalPrice); //import cloneDeep from './cloneDeep.js';

},{"./shoppingChart.js":"gv70X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gv70X":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const cart = [];
const addToCart = function(product, money) {
    cart.push({
        product,
        money
    });
...
exports.default = function(dirty_word, dirty_word2) {
...
},{}]},["aUZyQ","mMh8q"], "mMh8q", "parcelRequire94c2")
